...
SIGNAL \dut_instance|add_instance|y_present~regout\ : std_logic;
SIGNAL \dut_instance|add_instance|s~0\ : std_logic;
...
\datau[0]\ : maxv_lcell
-- Equation(s):
-- datau(0) = DFFEAS((\datau[0]~0_combout\ & (!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\ & (\dut_instance|add_instance|s~0\))) # (!\datau[0]~0_combout\ & (((datau(0))))), 
-- GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , , , , , )
...
PORT MAP (
	...
	datab => \dut_instance|add_instance|s~0\,
...
-- Equation(s):
-- dut_input(3) = DFFEAS((((data(3)))), GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , \shift_reg~0_combout\, , , , 
-- )
...
-- Equation(s):
-- \dut_instance|add_instance|s~0\ = (!dut_input(3) & (dut_input(2) $ (\dut_instance|add_instance|y_present~regout\ $ (dut_input[1]))))
-- dut_input(1) = DFFEAS(\dut_instance|add_instance|s~0\, GLOBAL(\auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0)), VCC, , 
...
PORT MAP (
	clk => \auto_hub|instrumentation_fabric_with_node_gen:fabric_gen_new_way:with_jtag_input_gen:instrumentation_fabric|instrumentation_fabric|alt_sld_fab|splitter_nodes_receive_0\(0),
	dataa => dut_input(2),
	datab => \dut_instance|add_instance|y_present~regout\,
	datac => data(1),
	datad => dut_input(3),
	aclr => GND,
	sload => VCC,
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \dut_instance|add_instance|s~0\,
	regout => dut_input(1));

-- Location: LC_X13_Y7_N7
\dut_instance|add_instance|y_present\ : maxv_lcell
-- Equation(s):
-- \dut_instance|add_instance|y_present~regout\ = DFFEAS((dut_input(2) & ((\dut_instance|add_instance|y_present~regout\) # ((dut_input(1))))) # (!dut_input(2) & (\dut_instance|add_instance|y_present~regout\ & (dut_input(1)))), dut_input(0), !dut_input(3), , 
-- , , , , )
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	regout => \dut_instance|add_instance|y_present~regout\);
...
-- pragma translate_on
PORT MAP (
	datain => \dut_instance|add_instance|s~0\,
	oe => VCC,
